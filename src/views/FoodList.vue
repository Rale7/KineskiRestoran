            ...
            <div class="col-sm-12 col-lg-4 col-xl-3">
                <div class="search-div">
                    ...
                    <div class="slide-container">
                        ...
                        <div class="result-div">{{ value1 }}-{{ value2 }}</div>
                    </div>
                    <hr />
                    <div class="slide-container">
                        <div class="slide-container-heading">
                        ...
                        <div class="result-div">{{ value3 }}-{{ value4 }}</div>
                    </div>
                    <hr />
                    ...
                    <div class="btn-group my-btn-group">
                        <button
                            type="button"
                            class="btn dropdown-toggle my-dropdown-button"
    ...
    methods: {
        ...
        filter() {
            ...
            allMeals.forEach((meal) => {
                if (
                    downBigBorder < meal["big-portion-price"] &&
                    meal["big-portion-price"] < upBigBorder &&
                    downSmallBorder < meal["small-portion-price"] &&
                    meal["small-portion-price"] < upSmallBorder &&
            ...
            } else if (this.sortingType == 'score-asc') {
                this.meals.sort((a, b) => parseFloat(this.getAvgRate(a)) - parseFloat(this.getAvgRate(b)));
            } else if (this.sortingType == 'score-desc') {
                this.meals.sort((a, b) => parseFloat(this.getAvgRate(b)) - parseFloat(this.getAvgRate(a)));
            }
        },
        getAvgRate(meal) {
