<template>
        ...
        <div class="title" style="font-size: 25px; padding-top: 0px;font-weight: bold"> 
            ...
            <div v-for="o in orders" :key="o.naziv" class="item">
            <div class="buttons">
            ...
            <div class="image">
            <img :src="o.img" alt="" style="width:90px; height:70px">
            </div>
            ...
            <!--<input type="text" name="name" value="">-->{{o.kolicina}} {{t("pcs")}}
        ...
        <div class="total-price">{{o.ukcena}}RSD</div>
        </div>
    </div>
</template>
